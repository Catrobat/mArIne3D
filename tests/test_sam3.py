...
def test_sam3_visual_killer_whale_tail_segmentation():
    ...
    # Load model with 512x512 rendering viewport for fast test inference
    ...
    # Save visual artifacts for each view
    ...
    # Save composite summary image for View 0
    first_img = images[0]
